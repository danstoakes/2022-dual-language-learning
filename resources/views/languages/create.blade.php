                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('languages.store') }}">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input class="form-control" type="text" name="excerpt" maxlength="255" oninput="changeCount(event, 'excerpt_characters')" onfocus="changeCount(event, 'excerpt_characters')" value="{{ old('excerpt') }}" />
